            ...
            <nav class="px-4 bg-black border-gray-200 text-white dark:bg-gray-600 dark:border-gray-800">
                <div class="container flex flex-wrap items-center justify-between mx-auto">
                    <a href="/" class="flex items-center">
                        <img src="https://img.freepik.com/premium-vector/pixel-art-joystick-icon-8bit-game-white-background_360488-222.jpg?w=740" class="h-12 mr-10 sm:h-10" alt="🎮" />
                        <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Nostalgia Games App</span>
                    </a>
